 ...
 */
public class TelaCategoriaPesquisar extends javax.swing.JFrame {

    /**
     * Creates new form TelaCategoriaPesquisar
     */
    public TelaCategoriaPesquisar() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("TV Master - Pesquisar Categoria");
        ...
        jLabel4.setText("DIGITE O NÚMERO DA CATEGORIA:");
                        ...
                        .addGroup(jPanelPesquisarLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanelPesquisarLayout.createSequentialGroup()
                                .addGroup(jPanelPesquisarLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(jTextFieldCategoria, javax.swing.GroupLayout.PREFERRED_SIZE, 281, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jPanelPesquisarLayout.setVerticalGroup(
            ...
            .addGroup(jPanelPesquisarLayout.createSequentialGroup()
                ...
                .addComponent(jTextFieldCategoria, javax.swing.GroupLayout.PREFERRED_SIZE, 40, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if(jTextFieldCategoria.getText().isEmpty()){
            JOptionPane.showMessageDialog(rootPane, "Digite um nome de categoria válido.");
        } else {
            Categoria categoria = new Categoria();
            categoria.setNome(jTextFieldCategoria.getText());
            categoria.pesquisar();
            Canal canal = new Canal();
            if(categoria.getId() == 0) {
                JOptionPane.showMessageDialog(rootPane, "O nome de categoria procurado não existe.");
            } else {
                mainPanel.removeAll();
                TelaCategoriaResultado t = new TelaCategoriaResultado(categoria);
                mainPanel.add(t.getPanel());
                mainPanel.repaint();
                mainPanel.revalidate();
                t.setTextFields();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaCategoriaPesquisar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaCategoriaPesquisar().setVisible(true);
            }
        });
    }
